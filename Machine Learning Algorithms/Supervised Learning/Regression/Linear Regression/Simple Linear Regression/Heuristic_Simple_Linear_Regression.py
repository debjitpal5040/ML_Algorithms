...
# read the csv file
df = pd.read_csv('Machine Learning Algorithms/Supervised Learning/Regression/Linear Regression/Simple Linear Regression/Salary_Data.csv')
...
plt.savefig('Machine Learning Algorithms/Supervised Learning/Regression/Linear Regression/Simple Linear Regression/Images/Heuristic_Simple_Linear_Regression.png', bbox_inches='tight', dpi=150)  # saving the plot
