...
plt.savefig("Machine Learning/Supervised Learning/Regression/Linear Regression/Multiple Linear Regression/multiple_linear_regression_manual.png",bbox_inches='tight',dpi=150) #saving the plot
plt.show()
